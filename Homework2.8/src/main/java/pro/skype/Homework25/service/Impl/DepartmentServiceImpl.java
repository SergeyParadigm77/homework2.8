...
import pro.skype.Homework25.service.DepartmentService;
...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public Employee ReturnEmployeeWithMaxSalary(Integer departmentId) {
        ...
        return employees.stream().filter(it -> it.getDepartment() == departmentId).max(Comparator.comparing(Employee::getSalary)).get();
    }
